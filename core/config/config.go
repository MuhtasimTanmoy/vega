...
type Config struct {
	...
	PrimaryEthereum     eth.Config             `group:"Ethereum"          namespace:"ethereum"`
	SecondaryEthereum   eth.Config             `group:"Ethereum"          namespace:"secondary_ethereum"`
	...
	PrimaryEvtForward   evtforward.Config      `group:"EvtForward"        namespace:"evtForward"`
	SecondaryEvtForward evtforward.Config      `group:"EvtForward"        namespace:"secondaryEvtForward"`
...
func NewDefaultConfig() Config {
	return Config{
		...
		PrimaryEthereum:     eth.NewDefaultConfig(),
		...
		PrimaryEvtForward:   evtforward.NewDefaultConfig(),
...
func (c Config) HaveEthClient() bool {
	return c.IsValidator() && len(c.PrimaryEthereum.RPCEndpoint) > 0
}
