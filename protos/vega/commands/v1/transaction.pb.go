...
func (x *InputData) GetSubmitAmm() *SubmitAMM {
	if x, ok := x.GetCommand().(*InputData_SubmitAmm); ok {
		return x.SubmitAmm
	}
	return nil
}

func (x *InputData) GetAmendAmm() *AmendAMM {
	if x, ok := x.GetCommand().(*InputData_AmendAmm); ok {
		return x.AmendAmm
	}
	return nil
}

func (x *InputData) GetCancelAmm() *CancelAMM {
	if x, ok := x.GetCommand().(*InputData_CancelAmm); ok {
		return x.CancelAmm
	}
	return nil
}
...
type InputData_SubmitAmm struct {
	// Command to submit an AMM pool to a market
	SubmitAmm *SubmitAMM `protobuf:"bytes,1023,opt,name=submit_amm,json=submitAmm,proto3,oneof"`
}

type InputData_AmendAmm struct {
	// Command to amend an AMM pool to a market
	AmendAmm *AmendAMM `protobuf:"bytes,1024,opt,name=amend_amm,json=amendAmm,proto3,oneof"`
}

type InputData_CancelAmm struct {
	// Command to cancel an AMM pool to a market
	CancelAmm *CancelAMM `protobuf:"bytes,1025,opt,name=cancel_amm,json=cancelAmm,proto3,oneof"`
}
...
func (*InputData_SubmitAmm) isInputData_Command() {}

func (*InputData_AmendAmm) isInputData_Command() {}
...
var file_vega_commands_v1_transaction_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xc5, 0x18, 0x0a, 0x09, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12,
	...
	0x54, 0x65, 0x61, 0x6d, 0x12, 0x3d, 0x0a, 0x0a, 0x73, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x5f, 0x61,
	0x6d, 0x6d, 0x18, 0xff, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x76, 0x65, 0x67, 0x61,
	...
	0x18, 0x80, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x63,
	...
	0x3d, 0x0a, 0x0a, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x5f, 0x61, 0x6d, 0x6d, 0x18, 0x81, 0x08,
	...
	0x4d, 0x48, 0x00, 0x52, 0x09, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x41, 0x6d, 0x6d, 0x12, 0x3a,
...
var file_vega_commands_v1_transaction_proto_goTypes = []interface{}{
	...
	(*SubmitAMM)(nil),                      // 26: vega.commands.v1.SubmitAMM
	(*AmendAMM)(nil),                       // 27: vega.commands.v1.AmendAMM
	(*CancelAMM)(nil),                      // 28: vega.commands.v1.CancelAMM
	(*NodeVote)(nil),                       // 29: vega.commands.v1.NodeVote
	(*NodeSignature)(nil),                  // 30: vega.commands.v1.NodeSignature
	(*ChainEvent)(nil),                     // 31: vega.commands.v1.ChainEvent
	(*KeyRotateSubmission)(nil),            // 32: vega.commands.v1.KeyRotateSubmission
	(*StateVariableProposal)(nil),          // 33: vega.commands.v1.StateVariableProposal
	(*ValidatorHeartbeat)(nil),             // 34: vega.commands.v1.ValidatorHeartbeat
	(*EthereumKeyRotateSubmission)(nil),    // 35: vega.commands.v1.EthereumKeyRotateSubmission
	(*ProtocolUpgradeProposal)(nil),        // 36: vega.commands.v1.ProtocolUpgradeProposal
	(*IssueSignatures)(nil),                // 37: vega.commands.v1.IssueSignatures
	(*OracleDataSubmission)(nil),           // 38: vega.commands.v1.OracleDataSubmission
	(*Signature)(nil),                      // 39: vega.commands.v1.Signature
}
var file_vega_commands_v1_transaction_proto_depIdxs = []int32{
	...
	26, // 22: vega.commands.v1.InputData.submit_amm:type_name -> vega.commands.v1.SubmitAMM
	27, // 23: vega.commands.v1.InputData.amend_amm:type_name -> vega.commands.v1.AmendAMM
	28, // 24: vega.commands.v1.InputData.cancel_amm:type_name -> vega.commands.v1.CancelAMM
	29, // 25: vega.commands.v1.InputData.node_vote:type_name -> vega.commands.v1.NodeVote
	30, // 26: vega.commands.v1.InputData.node_signature:type_name -> vega.commands.v1.NodeSignature
	31, // 27: vega.commands.v1.InputData.chain_event:type_name -> vega.commands.v1.ChainEvent
	32, // 28: vega.commands.v1.InputData.key_rotate_submission:type_name -> vega.commands.v1.KeyRotateSubmission
	33, // 29: vega.commands.v1.InputData.state_variable_proposal:type_name -> vega.commands.v1.StateVariableProposal
	34, // 30: vega.commands.v1.InputData.validator_heartbeat:type_name -> vega.commands.v1.ValidatorHeartbeat
	35, // 31: vega.commands.v1.InputData.ethereum_key_rotate_submission:type_name -> vega.commands.v1.EthereumKeyRotateSubmission
	36, // 32: vega.commands.v1.InputData.protocol_upgrade_proposal:type_name -> vega.commands.v1.ProtocolUpgradeProposal
	37, // 33: vega.commands.v1.InputData.issue_signatures:type_name -> vega.commands.v1.IssueSignatures
	38, // 34: vega.commands.v1.InputData.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	39, // 35: vega.commands.v1.Transaction.signature:type_name -> vega.commands.v1.Signature
	0,  // 36: vega.commands.v1.Transaction.version:type_name -> vega.commands.v1.TxVersion
	3,  // 37: vega.commands.v1.Transaction.pow:type_name -> vega.commands.v1.ProofOfWork
